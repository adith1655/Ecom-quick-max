...
```bash
git remote add encore encore://quick-max-e-commerce-s6e2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/quick-max-e-commerce-s6e2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/quick-max-e-commerce-s6e2/settings/integrations/github)
